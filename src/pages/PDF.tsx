...
export default function PDF() {
  ...
  <ThemeProvider theme={pdfTheme}>
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      {/* HEADER */}
      <header
        className={`sticky top-0 z-50 w-full backdrop-blur bg-white/80 border-b transition-shadow ${
          scrolled ? "shadow-sm" : ""
        }`}
      >
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  title: "Speed",
                  text: "Search dozens of assessor and planning databases instantly for the property you need.",
                },
                {
                  title: "Accuracy",
                  text: "We collect, compare, and verify property details from trusted official sources.",
                },
                {
                  title: "Ease of Use",
                  text: "All you do is enter an address — we do the rest. No forms, no waiting, just data.",
                },
              ].map(({ title, text }) => (
                <motion.div
                  key={title}
        ...
        <section id="beta" className="bg-indigo-50 py-16">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
            ...
            <p className="mt-2 text-slate-600">
              A short window to help shape the Property Data Finder. Early
              testers receive priority access and exclusive launch benefits.
            </p>
            <div className="mt-8 flex justify-center">
              <a
